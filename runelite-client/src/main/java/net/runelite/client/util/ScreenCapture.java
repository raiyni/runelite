...
public class ScreenCapture
{
	 ...
	 */
	public void takeScreenshot(BufferedImage screenshot, String subDirectory)
	{
		takeScreenshot(screenshot, null, subDirectory, true, true);
	}
	...
	{
		takeScreenshot(screenshot, name, null, notify, upload);
	}
	 ...
	 * @param upload Upload the image to a hosting service.
	 */
	public void takeScreenshot(BufferedImage screenshot, String name, String subDirectory, boolean notify, boolean upload)
	{
